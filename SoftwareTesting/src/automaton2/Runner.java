...
public class Runner {
	...
	public void viewAlertsWithValidLayout() throws IOException {
		...
		this.alertsAreVerified = this.validateAlerts(alerts);
	}
	...
	public void viewAlertsWithInvalidLayout() throws IOException {
		System.out.println("Viewing Alerts");
		this.alertsAreVerified = false;
	}
	...
	public void run() throws IOException {
		...
		while (true) {
			...
			if (randomNumber < 5) {
				...
				this.viewAlertsWithValidLayout();
			} else {
				System.out.println("invalid");
				this.viewAlertsWithInvalidLayout();
			}
		}
	}
